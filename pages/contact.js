            ...
            <Layout>
                ...
                <section className="section pt-80 mb-70 bg-faqs">
                    <div className="container">
                        ...
                        <section className="section mt-100">
                    <div className="container position-relative">
                        <h2 className=" mb-20 wow animate__animated animate__fadeIn">Frequently asked questions</h2>
                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Find answers to common questions about orders, returns, and more.</p>
                        <div className="row mt-50">
                            <div className="col-lg-6">
                            <h4 className="color-brand-2 mb-15">Testing</h4>
                            <p className="font-sm color-grey-900 mb-45">We provide advanced tools and machinery and ensure businesses meet top safety and performance standards.</p>

                                <div className="item-faqs-2 mb-30"><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">What types of product testing does Instacertify facilitate?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">We use NABL-accredited labs to conduct BIS, BEE, EPR, and other industry-specific testing.</p>
                                </div>
                                <div className="item-faqs-2 mb-30"><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">How do I choose the right testing equipment for BIS certification?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Our team of professionals suggests equipment that satisfies your product's testing and
                                    certification requirements.</p>
                                </div>
                                <div className="item-faqs-2 mb-30"><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">Are NABL-accredited labs mandatory for certification testing?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Yes, NABL-accredited laboratories are required to provide trustworthy and compliance test findings.</p>
                                </div>
                                <div className="item-faqs-2 mb-30"><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">Can Instacertify arrange testing in multiple Indian states?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Yes, we have partnerships with NABL-accredited labs nationwide.</p>
                                </div>
                            </div>
                            <div className="col-lg-6">
                            <h4 className="color-brand-2 mb-15">Certification
                            </h4>
                            <p className="font-sm color-grey-900 mb-45">We can help if you need to check your order status, return or exchange an item, or even learn more about Lowe’s order pickup.</p>

                                <div className="item-faqs-2 mb-30 "><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">What certifications does Instacertify help with?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Instacertify offers services for BIS-ISI (FMCS & Domestic), CRS (FMCS &am; Domestic), BEE, Hallmarking, WPC-ETA Registration, IMEI-ICDR, EPR (Plastic, E-Waste, Battery Waste), G Mark, Saber, CDSCO, LMPC, Sedex, and others.</p>
                                </div>
                                <div className="item-faqs-2 mb-30"><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">Why is BIS certification mandatory for certain products in India?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">BIS certification assures that items fulfill India's safety, quality, and performance                                    standards. Specific items require compliance with environmental regulations.</p>
                                </div>
                                <div className="item-faqs-2 mb-30"><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">What is the difference between BIS-ISI and BIS-CRS certification?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">BIS-ISI certification applies to items that meet safety, quality, and performance 
                                    criteria. CRS applies only to registered electronic and information technology items.</p>
                                </div>
                                <div className="item-faqs-2 mb-30"><Link href='/'>
                                    <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">How long does it take to get product certification from BIS?</h6></Link>
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Depending on the product and certification type, testing, paperwork, and inspection
                                    might take anywhere from 30 to 90 days.</p>
                                </div>
                            </div>
                        </div>
                    </div>
